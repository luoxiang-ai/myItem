...
<div id="desk_viewNewsDiv" style="padding: 10px;display: none;">
    ...
    <div style="text-align: right;">
        ...
        <font color="green" size="3">发布时间</font>：<span id="view_createtime"></span>
    </div>
    <hr>
...
<script type="text/javascript">
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用教学管理系统。当前时间为： "+newDate+"　"+week;
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        $.get("${pageContext.request.contextPath}/news/loadAllNews.action?page=1&limit=10",function(data){
            ...
            var len =  dataLength >= 10 ? 10 : dataLength;
            for(var i=0;i<len;i++){
