...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table' ,'upload', 'layedit', 'laydate'], function() {
        ...
        tableIns=table.render({
            elem: '#scoreTable'   //渲染的目标对象
            ,url:'${pageContext.request.contextPath}/scoreInfo/loadScoreById.action?sid=' + ${sessionScope.sysUser.userid} //数据接口
            ,title: '成绩信息数据表'//数据导出来的标题
            ,height:'full-200'
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${pageContext.request.contextPath}/scoreInfo/loadScoreByCourseName.action?"+params,
                page:{curr:1}
            })
        });
