 ...
 * Generated at: 2021-01-28 05:51:32 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.pages.system.class_;
...
public final class classManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <a class=\"layui-btn layui-btn-xs layui-btn-normal\" lay-event=\"viewUser\">查看成员</a>\r\n");
      ...
      out.write("                <input type=\"hidden\" id=\"hiddenId\" name=\"classId\">\r\n");
      out.write("                <input type=\"text\" lay-verify=\"required\" name=\"className\" class=\"layui-input\" placeholder=\"请输入班级名称\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("<div style=\"display: none;padding: 10px;\" id=\"showUser\">\r\n");
      ...
      out.write("            ,url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/loadAllClass.action' //数据接口\r\n");
      out.write("            ,title: '班级信息数据表'//数据导出来的标题\r\n");
      ...
      out.write("                ,{field:'classId', title:'编号',align:'center'}\r\n");
      out.write("                ,{field:'className', title:'班级名称',align:'center'}\r\n");
      out.write("                ,{fixed: 'right', title:'操作', toolbar: '#classBar', width:280,align:'center'}\r\n");
      out.write("            ]]\r\n");
      ...
      out.write("                url:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/fuzzyQueryClass.action?\"+params,\r\n");
      ...
      out.write("                layer.confirm('真的删除【'+data.className+'】这个班级吗', function(index){\r\n");
      out.write("                    //向服务端发送删除指令\r\n");
      out.write("                    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/deleteClass.action\",{id:data.classId},function(res){\r\n");
      ...
      out.write("            } else if (layEvent === 'viewUser') {  // 查看班级成员\r\n");
      out.write("                showClassStudent(data);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        var url;\r\n");
      ...
      out.write("                    url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/addClass.action\";\r\n");
      out.write("                }\r\n");
      out.write("            })\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("                    url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/updateClass.action\";\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        //保存\r\n");
      ...
      out.write("                if(i==0){\r\n");
      out.write("                    params+=\"ids=\"+item.classId;\r\n");
      out.write("                }else{\r\n");
      out.write("                    params+=\"&ids=\"+item.classId;\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("            layer.confirm('真的删除选中的这些班级吗', function(index){\r\n");
      out.write("                //向服务端发送删除指令\r\n");
      out.write("                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/class/batchDeleteClass.action\",params,function(res){\r\n");
      out.write("                    layer.msg(res.msg);\r\n");
      out.write("                    //刷新数据 表格\r\n");
      out.write("                    tableIns.reload();\r\n");
      out.write("                })\r\n");
      ...
      out.write("\r\n");
      out.write("        // 查看班级学生\r\n");
      out.write("        function showClassStudent(data) {\r\n");
      out.write("            console.log(data);\r\n");
      out.write("            layer.open({\r\n");
      out.write("                type:1,\r\n");
      out.write("                title:'正在要查看【' + data.className + '】的学生列表',\r\n");
      out.write("                content:$(\"#showUser\"),\r\n");
      ...
      out.write("                        ,url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/student/loadStudentByClassId.action?classId=' + data.classId //数据接口\r\n");
