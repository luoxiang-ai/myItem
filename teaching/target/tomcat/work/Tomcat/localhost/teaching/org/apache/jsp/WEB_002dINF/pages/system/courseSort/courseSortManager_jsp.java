 ...
 * Generated at: 2021-02-02 13:52:07 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.pages.system.courseSort;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class courseSortManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <input type=\"text\" name=\"cname\"  autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- 数据表格开始 -->\r\n");
      out.write("<table class=\"layui-hide\" id=\"courseSortTable\" lay-filter=\"courseSortTable\"></table>\r\n");
      out.write("<div style=\"display: none;\" id=\"courseSortToolBar\">\r\n");
      out.write("    <button type=\"button\" class=\"layui-btn layui-btn-sm\" lay-event=\"add\">增加</button>\r\n");
      out.write("\r\n");
      out.write("</div>\r\n");
      out.write("<div  id=\"courseSortBar\" style=\"display: none;\">\r\n");
      ...
      out.write("    <a class=\"layui-btn layui-btn-normal layui-btn-xs\" lay-event=\"viewCourse\">查看课程</a>\r\n");
      out.write("</div>\r\n");
      out.write("<!-- 数据表格结束 -->\r\n");
      out.write("\r\n");
      ...
      out.write("                <input type=\"text\" name=\"cname\"  placeholder=\"请输入课程分类标题\" autocomplete=\"off\"\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- 查看课程分类的div -->\r\n");
      out.write("<div id=\"viewCourseDiv\" style=\"padding: 10px;display: none;\">\r\n");
      ...
      out.write("            elem: '#courseSortTable'   //渲染的目标对象\r\n");
      out.write("            ,url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/loadAllCourseSort.action' //数据接口\r\n");
      out.write("            ,title: '客户分类数据表'//数据导出来的标题\r\n");
      out.write("            ,toolbar:\"#courseSortToolBar\"   //表格的工具条\r\n");
      ...
      out.write("                ,{field:'cname', title:'分类标题',align:'center'}\r\n");
      out.write("                ,{fixed: 'right', title:'操作', toolbar: '#courseSortBar', width:220,align:'center'}\r\n");
      out.write("            ]]\r\n");
      out.write("        })\r\n");
      out.write("        //模糊查询\r\n");
      ...
      out.write("                url:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/fuzzyQueryCourseSort.action?\"+params,\r\n");
      out.write("                page:{curr:1}\r\n");
      out.write("            })\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        //监听头部工具栏事件\r\n");
      out.write("        table.on(\"toolbar(courseSortTable)\",function(obj){\r\n");
      out.write("            switch(obj.event){\r\n");
      out.write("                case 'add':\r\n");
      out.write("                    openAddCourseSort();\r\n");
      out.write("                    break;\r\n");
      ...
      out.write("        })\r\n");
      out.write("        //监听行工具事件\r\n");
      out.write("        table.on('tool(courseSortTable)', function(obj){\r\n");
      ...
      out.write("                layer.confirm('真的删除【'+data.cname+'】这个课程分类吗', function(index){\r\n");
      out.write("                    //向服务端发送删除指令\r\n");
      out.write("                    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/deleteCourseSort.action\",{id:data.id},function(res){\r\n");
      ...
      out.write("                openUpdateCourseSort(data);\r\n");
      out.write("            }else if(layEvent ==='viewCourse'){\r\n");
      out.write("                viewCourseSort(data);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        var url;\r\n");
      ...
      out.write("        //打开添加页面\r\n");
      out.write("        function openAddCourseSort(){\r\n");
      out.write("            mainIndex=layer.open({\r\n");
      out.write("                type:1,\r\n");
      out.write("                title:'添加课程分类',\r\n");
      ...
      out.write("                    url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/addCourseSort.action\";\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        //打开修改页面\r\n");
      out.write("        function openUpdateCourseSort(data){\r\n");
      out.write("            mainIndex=layer.open({\r\n");
      out.write("                type:1,\r\n");
      out.write("                title:'修改课程分类',\r\n");
      out.write("                content:$(\"#saveOrUpdateDiv\"),\r\n");
      out.write("                area:['800px','400px'],\r\n");
      out.write("                success:function(index){\r\n");
      ...
      out.write("                    url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/updateCourseSort.action\";\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("        //查看\r\n");
      out.write("        function viewCourseSort(data){\r\n");
      out.write("            mainIndex=layer.open({\r\n");
      out.write("                type:1,\r\n");
      out.write("                title:'正在查看【' + data.cname +  '】分类下的课程',\r\n");
      out.write("                content:$(\"#viewCourseDiv\"),\r\n");
      out.write("                area:['800px','400px'],\r\n");
      out.write("                success:function(index){\r\n");
      out.write("                    //渲染数据表格\r\n");
      ...
      out.write("                        ,url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/course/loadCourseBySortId.action?sid=' + data.id //数据接口\r\n");
      out.write("                        ,title: '课程数据表'//数据导出来的标题\r\n");
      out.write("                        ,height:'full-200'\r\n");
      out.write("                        ,cellMinWidth:100 //设置列的最小默认宽度\r\n");
      out.write("                        ,page: true  //是否启用分页\r\n");
      out.write("                        ,cols: [[   //列表数据\r\n");
      ...
      out.write("            //得到选中的数据行\r\n");
      out.write("            var checkStatus = table.checkStatus('courseSortTable');\r\n");
      ...
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("            layer.confirm('真的删除选中的这些课程分类吗', function(index){\r\n");
      out.write("                //向服务端发送删除指令\r\n");
      out.write("                    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/courseSort/deleteBatchCourseSort.action\",params,function(res){\r\n");
      out.write("                        layer.msg(res.msg);\r\n");
      out.write("                        //刷新数据 表格\r\n");
      out.write("                        tableIns.reload();\r\n");
      out.write("                })\r\n");
