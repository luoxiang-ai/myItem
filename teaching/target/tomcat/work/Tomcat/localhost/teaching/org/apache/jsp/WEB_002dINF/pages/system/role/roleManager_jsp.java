 ...
 * Generated at: 2021-01-28 05:34:18 UTC
...
public final class roleManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <input type=\"text\" name=\"rolename\"  autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"layui-inline\">\r\n");
      ...
      out.write("    <a class=\"layui-btn layui-btn-xs layui-btn-normal\" lay-event=\"selectRoleMenu\">分配菜单</a>\r\n");
      ...
      out.write("                <input type=\"text\" name=\"roledesc\"  placeholder=\"请输入角色描述\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"layui-form-item\">\r\n");
      out.write("            <div class=\"layui-inline\">\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- 角色权限设置的弹出层开始 -->\r\n");
      out.write("<div style=\"display: none;\" id=\"selectRoleMenu\">\r\n");
      out.write("    <ul id=\"menuTree\" id=\"dtree\" data-id=\"0\"></ul>\r\n");
      out.write("</div>\r\n");
      out.write("<!-- 角色权限设置的弹出层结束 -->\r\n");
      out.write("\r\n");
      ...
      out.write("        dtree:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/resources/layui_ext/dtree/dtree'\r\n");
      ...
      out.write("                ,{field:'roleid', title:'ID',align:'center',sort: true}\r\n");
      out.write("                ,{field:'rolename', title:'角色名称',align:'center'}\r\n");
      out.write("                ,{field:'roledesc', title:'描述',align:'center'}\r\n");
      out.write("                ,{field:'available', title:'是否可用',align:'center',sort:true,templet:function(d){\r\n");
      ...
      out.write("                url:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/fuzzyQueryRole.action?\"+params\r\n");
      out.write("            })\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        //监听头部工具栏事件\r\n");
      ...
      out.write("                layer.confirm('您确定删除【' + data.rolename + '】这个角色吗', function (index) {\r\n");
      ...
      out.write("            } else if (layEvent == 'selectRoleMenu') {\r\n");
      ...
      out.write("            $(\"#roleSelectDiv\").toggleClass(\"layui-show layui-anim layui-anim-upbit\");\r\n");
      out.write("        });\r\n");
      out.write("        dtree.on(\"node(roleTree)\", function(obj){\r\n");
      ...
      out.write("\r\n");
      out.write("        // 批量删除角色\r\n");
      out.write("        function batchDeleteRoles() {\r\n");
      ...
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            layer.confirm('您确定要批量删除这些角色吗', function (index) {\r\n");
      out.write("            //    向服务端发送删除请求\r\n");
      out.write("                $.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write("                    $.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/saveRoleMenu.action', params, function (res) {\r\n");
      out.write("                        layer.close(index);     // 关闭弹层\r\n");
      out.write("                        layer.msg(res.msg);\r\n");
      out.write("                    });\r\n");
      out.write("                },\r\n");
      out.write("                success: function (layero, index) {     // 弹出后成功的回调方法\r\n");
      out.write("                //    初始化树\r\n");
      out.write("                    menuTree = dtree.render({\r\n");
      out.write("                        elem: '#menuTree',\r\n");
      out.write("                        dataStyle: 'layuiStyle',\r\n");
      out.write("                        response: {message: 'msg', statusCode: 0},\r\n");
      out.write("                        dataFormat: 'list',\r\n");
      out.write("                        checkbar: true,     // 开启复选框\r\n");
      ...
      out.write("            url:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/loadAllRole.action?id=\"+id\r\n");
      out.write("        })\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("\r\n");
