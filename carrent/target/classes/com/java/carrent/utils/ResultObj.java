...
public class ResultObj {
     ...
     * 修改失败
     */
    public static final ResultObj UPDATE_ERROR = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.UPDATE_ERROR);
    /**
     * 删除成功
     */
     ...
     * 添加到黑名单成功
     */
    public static final ResultObj ADD_TO_BLACKLIST_SUCCESS = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.ADD_TO_BLACKLIST_SUCCESS);
    /**
     * 添加到黑名单失败
     */
    public static final ResultObj ADD_TO_BLACKLIST_ERROR = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.ADD_TO_BLACKLIST_ERROR);

    /**
     * 移出黑名单成功
     */
    public static final ResultObj DELETE_BLACKLIST_SUCCESS = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.DELETE_BLACKLIST_SUCCESS);
    /**
     * 移出黑名单失败
     */
    public static final ResultObj DELETE_BLACKLIST_ERROR = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.DELETE_BLACKLIST_ERROR);
