...
<html>
    ...
    <body class="childrenBody">
        ...
        <div id="workFlowBar" style="display: none;">
            <a class="layui-btn layui-btn-xs">审批</a>
        ...
        <script type="text/javascript">
            ...
            layui.use([ 'jquery', 'layer', 'form', 'table','laydate', 'upload'], function() {
                ...
                tableIns=table.render({
                    ...
                    ,url:'${pageContext.request.contextPath}/workFlow/loadCurrentUserTask.action' //数据接口
                    ...
                    ,cols: [[   //列表数据
                        ...
                        ,{field:'deploymentTime', title:'申请时间',align:'center'}
