    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="rentid" placeholder="请输入出租单号" autocomplete="off" id="rentId" class="layui-input">
            </div>
    ...
    <blockquote class="layui-elem-quote" style="margin-top: 10px;">
        ...
        <form class="layui-form" method="post" id="checkFrm" lay-filter="checkFrm">
            ...
            <div class="layui-form-item" style="text-align: center;">
                <button type="button" class="layui-btn layui-btn-normal" id="doSubmit" lay-submit="" lay-filter="doSubmit">保存</button>
            </div>
        </form>
    </blockquote>
    <hr class="layui-bg-green">
...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'], function() {
        ...
        function initCheckFormData(rentid) {
            $.post('${pageContext.request.contextPath}/check/initCheckFormData.action', {rentId: rentid}, function(res) {
            //    检查单
                var check = res.check;
